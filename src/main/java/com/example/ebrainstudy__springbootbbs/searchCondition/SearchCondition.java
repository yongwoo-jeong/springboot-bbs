...
public class SearchCondition {
	private static SearchConditionVO storedCondition;

	public void setStoredCondition(SearchConditionVO storedCondition) {
		SearchCondition.storedCondition = storedCondition;
	}
